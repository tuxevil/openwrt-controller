...
const sectorRoutes = {
  CORE_VISIBILITY:    [/^\/site\/[^/]+$/, /topology/, /clients/],
    ...
    >
      ...
      <nav class="flex flex-col flex-1 select-none">
        ...
        <div class="mb-1">
          ...
          <div class="overflow-hidden transition-all duration-200 ease-in-out" :style="openSector === 'CORE_VISIBILITY' ? 'max-height:200px;opacity:1' : 'max-height:0;opacity:0'">
